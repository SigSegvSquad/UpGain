...
declare class RequestInfo_2<T> {
    ...
    errorHandler: ((p1: XhrIo, p2: FirebaseStorageError_2) => FirebaseStorageError_2) | null;
    /**
...
declare class StorageService_2 implements _FirebaseService {
     ...
     * FirebaseApp associated with this StorageService instance.
     */
    app: FirebaseApp, _authProvider: Provider<FirebaseAuthInternalName>, _pool: XhrIoPool, _url?: string | undefined, _firebaseVersion?: string | undefined);
    get host(): string;
    /**
 ...
 */
declare interface XhrIo {
    send(url: string, method: string, body?: ArrayBufferView | Blob | string | null, headers?: Headers_2): Promise<XhrIo>;
