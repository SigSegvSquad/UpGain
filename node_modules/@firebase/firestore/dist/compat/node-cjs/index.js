...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.useEmulator = function (host, port) {
        firestore.useFirestoreEmulator(this._delegate, host, port);
    };
...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.get = function (documentRef) {
        ...
        return this._delegate
            .get(ref)
            .then(function (result) { return new DocumentSnapshot(_this._firestore, new firestore.DocumentSnapshot(_this._firestore._delegate, _this._userDataWriter, result._key, result._document, result.metadata, ref._converter)); });
    };
...
var DocumentReference = /** @class */ (function () {
    ...
    DocumentReference.prototype.onSnapshot = function () {
        ...
        var observer = wrapObserver(args, function (result) { return new DocumentSnapshot(_this.firestore, new firestore.DocumentSnapshot(_this.firestore._delegate, _this._userDataWriter, result._key, result._document, result.metadata, _this._delegate._converter)); });
    ...
    DocumentReference.prototype.get = function (options) {
        ...
        return snap.then(function (result) { return new DocumentSnapshot(_this.firestore, new firestore.DocumentSnapshot(_this.firestore._delegate, _this._userDataWriter, result._key, result._document, result.metadata, _this._delegate._converter)); });
    };
