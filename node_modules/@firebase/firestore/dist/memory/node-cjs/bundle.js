...
function loadBundle(data) {
    return database3cfd76ce.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database3cfd76ce.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database3cfd76ce.Query$1(this, 
...
registerBundle(database3cfd76ce.Firestore);
