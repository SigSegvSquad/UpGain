(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@firebase/app'), require('@firebase/component'), require('@firebase/logger'), require('util'), require('node-fetch'), require('@firebase/util'), require('crypto')) :
    typeof define === 'function' && define.amd ? define(['exports', 'tslib', '@firebase/app', '@firebase/component', '@firebase/logger', 'util', 'node-fetch', '@firebase/util', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.firebase = global.firebase || {}, global.firebase.firestore = {}), global.tslib, global.app, global.component, global.logger, global.util$1, global.nodeFetch, global.util, global.crypto));
}(this, (function (exports, tslib, app, component, logger, util$1, nodeFetch, util, crypto) { 'use strict';
    ...
    var DatabaseInfo = /** @class */ (function () {
         ...
         */
        function DatabaseInfo(databaseId, appId, persistenceKey, host, ssl, forceLongPolling, autoDetectLongPolling) {
    ...
    var X_GOOG_API_CLIENT_VALUE = 'gl-js/ fire/' + version$1;
    /**
    ...
    var ObjectValue = /** @class */ (function () {
        ...
        ObjectValue.prototype.toProto = function () {
         ...
         * needed.
         */
        ObjectValue.prototype.setOverlay = function (path, value) {
         ...
         * were applied.
         */
        ObjectValue.prototype.applyOverlay = function (currentPath, currentOverlays) {
            var _this = this;
            var modified = false;
            var existingValue = ObjectValue.extractNestedValue(this.partialValue, currentPath);
         ...
         */
        ObjectValue.prototype.buildProto = function () {
        ...
        ObjectValue.extractNestedValue = function (proto, path) {
            if (path.isEmpty()) {
                return proto;
            }
            else {
    ...
    function getDoc(reference) {
        ...
        return invokeBatchGetDocumentsRpc(datastore, [reference._key]).then(function (result) {
            ...
            return new DocumentSnapshot(reference.firestore, userDataWriter, reference._key, document.isFoundDocument() ? document : null, reference._converter);
        });
    }
    /**
    ...
    function getDocs(query) {
        ...
        return invokeRunQueryRpc(datastore, query._query).then(function (result) {
            var docs = result.map(function (doc) { return new QueryDocumentSnapshot(query.firestore, userDataWriter, doc.key, doc, query._converter); });
