...
const X_GOOG_API_CLIENT_VALUE = 'gl-js/ fire/' + version$1;
/**
...
function getDocs(query) {
    ...
    return invokeRunQueryRpc(datastore, query._query).then(result => {
        const docs = result.map(doc => new QueryDocumentSnapshot(query.firestore, userDataWriter, doc.key, doc, query._converter));
