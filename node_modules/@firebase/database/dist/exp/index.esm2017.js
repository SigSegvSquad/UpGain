...
import { stringify, jsonEval, contains, assert, base64, stringToByteArray, Sha1, isNodeSdk, deepCopy, base64Encode, isMobileCordova, stringLength, Deferred, safeGet, isAdmin, isValidFormat, isEmpty, isReactNative, assertionError, map, querystring, errorPrefix, getModularInstance } from '@firebase/util';
...
class BrowserPollConnection {
    ...
    constructor(connId, repoInfo, applicationId, transportSessionId, lastSessionId) {
        ...
        this.urlFn = (params) => repoInfoConnectionURL(repoInfo, LONG_POLLING, params);
    }
    /**
 ...
 */
class Repo {
    constructor(repoInfo_, forceRestClient_, authTokenProvider_) {
        this.repoInfo_ = repoInfo_;
...
class ChildEventRegistration {
    ...
    getEventRunner(eventData) {
        if (eventData.getEventType() === 'cancel') {
            ...
            return () => cancelCB.onCancel(eventData.error);
        }
        else {
            const cb = this.callbacks[eventData.eventType];
            return () => cb.onValue(eventData.snapshot, eventData.prevName);
        }
    }
    matches(other) {
            ...
            if (!this.callbacks || !other.callbacks) {
                ...
                if (otherCount === thisCount) {
                    ...
                    if (otherCount === 1) {
                        ...
                        return thisKeys.every(eventType => other.callbacks[eventType].matches(this.callbacks[eventType]));
                    }
                }
            }
        }
