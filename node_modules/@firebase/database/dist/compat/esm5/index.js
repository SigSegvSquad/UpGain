...
import { __spreadArray, __read, __extends, __values, __assign } from 'tslib';
...
function initStandalone(_a) {
    ...
    return {
        instance: new Database(_repoManagerDatabaseFromApp(app, authProvider, url, nodeAdmin), app),
        namespace: namespace
    };
}
...
function registerDatabase(instance) {
    ...
    var namespace = instance.INTERNAL.registerComponent(new Component('database-compat', function (container, _a) {
